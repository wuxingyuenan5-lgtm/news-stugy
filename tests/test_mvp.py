    ...
    def test_pipeline_fuses_sources_and_isolates_report_date(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with connect(root / "test.db") as conn:
                ...
                count = cluster_items(conn, item_ids, "2026-07-18")
                ...
                cluster_items(conn, item_ids[:1], "2026-07-19")
                self.assertEqual(len(load_events(conn, "2026-07-19")), 1)
